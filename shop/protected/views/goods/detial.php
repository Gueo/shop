...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body style="cursor: auto;">
                            ...
                            <ul>
                                ...
                                <li class="padd loop">
                                    ...
                                    <label for="spec_value_227">
                                        <input name="spec_185" value="227" id="spec_value_227" checked="checked" onclick="changePrice()" type="radio" />
                                        白色 [ ￥0.00元] </label>
                                    <label for="spec_value_226">
                                        <input name="spec_185" value="226" id="spec_value_226" onclick="changePrice()" type="radio" />
                                        黑色 [加 ￥10.00元] </label>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo IMG_URL;?>goods.htm" alt="YONGDA商城" border="0" /></a>
        ...
        <img class="MagicThumb-image" style="position: absolute; top: -9999px; display: none;" src="<?php echo IMG_URL;?>9_P_1241511871575.jpg" />
        <img src="<?php echo IMG_URL;?>controlbar.htm" style="position: absolute; top: -999px;" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo IMG_URL;?>9_P_1241511871575.jpg" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo IMG_URL;?>9_P_1241511871575.jpg" />
    </body>
</html>